...
import "./warehouseLocations.scss";
...
const WarehouseLocations: React.FC<WarehouseLocationsProps> = ({ locations, onEdit, onDelete }) => {
  ...
  return (
    <div className="warehouse-locations fade-in">
